...
# compares v shapes with flip based against increasing or decreasing inertia weight
...
# Transfer functions
transfer_functions = [
    # {"name": "S1", "func": lambda v: 1/(1+np.exp(-v)), "type": "s", "inertia": "decreasing"},
    # {"name": "S2", "func": lambda v: 1/(1+np.exp(-v)), "type": "s", "inertia": "decreasing"},
    # {"name": "S3", "func": lambda v: 1/(1+np.exp(-v/2)), "type": "s", "inertia": "decreasing"},
    # {"name": "S4", "func": lambda v: 1/(1+np.exp(-v/3)), "type": "s", "inertia": "decreasing"},
    ...
    {"name": "V6", "func": lambda v: 1-np.exp((-1/2)*np.abs(v)), "type": "v", "inertia": "decreasing"},
    
    {"name": "v1", "func": lambda v: np.abs(erf(np.sqrt(np.pi)*v)), "type": "v", "inertia": "increasing"},
    {"name": "v2", "func": lambda v: np.abs(np.tanh(v)), "type": "v", "inertia": "increasing"},
    {"name": "v3", "func": lambda v: np.abs(v/np.sqrt(1+v**2)), "type": "v", "inertia": "increasing"},
    {"name": "v4", "func": lambda v: np.abs(2/np.pi*np.arctan(np.pi/2*v)), "type": "v", "inertia": "increasing"},
    {"name": "v5", "func": lambda v: 2/np.pi*np.arctan(v**2), "type": "v", "inertia": "increasing"},
    {"name": "v6", "func": lambda v: 1-np.exp((-1/2)*np.abs(v)), "type": "v", "inertia": "increasing"}
]
