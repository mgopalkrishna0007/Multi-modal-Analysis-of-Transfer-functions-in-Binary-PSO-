...
def algo1_binary_pso(func_info, num_particles=30, max_iter=100, runs=20, 
...
def algo2_binary_pso(func_info, num_particles=30, max_iter=100, runs=20, 
...
def algo3_binary_pso(func_info, num_particles=30, max_iter=100, runs=20, 
...
def algo4_binary_pso(func_info, num_particles=30, max_iter=100, runs=20, 
